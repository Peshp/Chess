    ...
    public partial class InitialMigrate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardFigures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoardFigures_UserBoards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "UserBoards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardFigures_UserBoards_UserBoardId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoardSquares_UserBoards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "UserBoards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoardSquares_UserBoards_UserBoardId",
                        column: x => x.UserBoardId,
                        principalTable: "UserBoards",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardFigures_BoardId",
                table: "BoardFigures",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardFigures_UserBoardId",
                table: "BoardFigures",
                column: "UserBoardId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardSquares_BoardId",
                table: "BoardSquares",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_BoardSquares_UserBoardId",
                table: "BoardSquares",
                column: "UserBoardId");
